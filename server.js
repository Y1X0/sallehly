...
const { sendPush, verifyGoogleIdToken, verifyFirebaseIdToken } = require('./services/push');
...
const deps = {
  ...
  services: { sendOtpEmail, sendPush, createDbBackup, sign, verifyGoogleIdToken, verifyFirebaseIdToken },
  ...
  constants: {
    ...
    FREE_TIER_QUOTA: env.FREE_TIER_QUOTA,
