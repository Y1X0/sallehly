...
// افتراضياً. مصمّمة لتبقى بالكود بشكل دائم كخيار تشغيلي بسيط (بعكس أداة
// التشخيص المؤقتة المستخدَمة سابقاً لجمع أدلة السبب الجذري، والتي أُزيلت
// بالكامل من الكود بعد اكتمال مهمتها — راجع سجل git للتفاصيل التاريخية).
//
